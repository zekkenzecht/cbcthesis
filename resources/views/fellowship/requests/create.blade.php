...
<div class="col-md-4">
    ...
    <div class="panel-body">
        ...
        {!! Form::text('name',null, ['placeholder' => 'Fellowship Name','class' => 'form-control']) !!}
        </div>
        <div class="form-group">
        {!! Form::label('desc','Description: ', ['class' => 'control-label']) !!}
        {!! Form::textarea('desc', null, ['class' => 'form-control','rows' => '5','placeholder' => 'Fellowship Description']) !!}
        </div>  
        <div class="form-group">
        {!! Form::label('venue','Venue:', ['class' => 'control-label']) !!}
        {!! Form::text('venue',null, ['placeholder' => 'Venue','class' => 'form-control']) !!}
        </div>
        <div class="form-group">   
        <div class="row">
