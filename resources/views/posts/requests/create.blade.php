...
<div class="row">
  <div class="col-md-11">
    <div class="form-group">
      {!! Form::open(['action' => 'Post\PostRequestController@store' ,'method' => 'post','enctype' => 'multipart/form-data','class' => 'form-horizontal']) !!}
      <div class="panel panel-success">
          <div class="panel-heading">
              <h3 class="panel-title"><strong>Create New</strong> Post Request</h3>
            ...
            <div class="panel-body">
              ...
              <div class="col-md-6">
                  {!! Form::submit('Make a Request', ['Class' => 'btn btn-lg btn-primary']) !!}<br><br>
                  {!! Form::submit('Save As Draft', ['Class' => 'btn btn-lg btn-info']) !!}<br>
              </div>
              </div>
              <div class="col-md-12">
